...
public enum ChatErrorCode  implements ResultCode {
    ...
    CONSULTATION_ALREADY_IN_PROGRESS(HttpStatus.CONFLICT, 5005, "이미 진행 중인 상담이 있습니다."),
    UNAUTHORIZED_SYSTEM_MESSAGE(HttpStatus.UNAUTHORIZED, 5006, "시스템 메시지를 보낼 권한이 없습니다.");
