...
public enum ConsultationErrorCode  implements ResultCode {
    ...
    CONSULTATION_EXPERT_PROFILE_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, 3006, "상담과 연결된 전문가 프로필이 없습니다."),
    RESERVATION_NOT_FOUND(HttpStatus.NOT_FOUND, 3008, "예약을 찾을 수 없습니다.");
